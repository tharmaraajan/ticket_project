    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0"><b>Priorities</b></h1>
                    </div>
                    <div class="col-sm-6">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('priority.edit',$priority->id)}}"
                                           class="btn btn-sm btn-secondary"><i class="bi bi-pencil-square"></i> Edit</a>
                                        <form action="{{ route('priority.delete', $priority->id) }}" method="post"
                                              class="d-inline">
                                            {{ csrf_field() }}
                                            @method('DELETE')
