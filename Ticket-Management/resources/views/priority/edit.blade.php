    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0"><b>Update Priority</b></h1>
                    </div>
                    <div class="col-sm-6">
                        ...
                        <div class="form col-sm-6">
                            <form method="post" action="{{route('priority.update',$priority->id)}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="ct-input form-control" value="{{$priority->priority_name}}" name="priority" id="priority" placeholder="Enter the Priority name here...">
                                    @error('prirority')
